...
#	
#######################DISA INFORMATION##################################
# Group ID (Vulid): RHEL-06-000186
# Group Title: SRG-OS-000064
#
   
# Rule ID: RHEL-06-000186_rule
# Severity: low
# Rule Version (STIG-ID): RHEL-06-000186
# Rule Title: The audit system must be configured to audit all 
# discretionary access control permission modifications using fchmod.
#
...
# Check Content:
#
# To determine if the system is configured to audit calls to the "fchmod" 
