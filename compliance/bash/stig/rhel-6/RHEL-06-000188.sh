...
#	
#######################DISA INFORMATION##################################
# Group ID (Vulid): RHEL-06-000188
# Group Title: SRG-OS-000064
#
   
# Rule ID: RHEL-06-000188_rule
# Severity: low
# Rule Version (STIG-ID): RHEL-06-000188
# Rule Title: The audit system must be configured to audit all 
# discretionary access control permission modifications using fchown.
#
...
# Check Content:
#
# To determine if the system is configured to audit calls to the "fchown" 
