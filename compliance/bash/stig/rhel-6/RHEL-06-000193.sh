...
#	
#######################DISA INFORMATION##################################
# Group ID (Vulid): RHEL-06-000193
# Group Title: SRG-OS-000064
#
   
# Rule ID: RHEL-06-000193_rule
# Severity: low
# Rule Version (STIG-ID): RHEL-06-000193
# Rule Title: The audit system must be configured to audit all 
# discretionary access control permission modifications using lremovexattr.
#
...
# -a always,exit -F arch=b32 -S lremovexattr -F auid>=500 -F 
# auid!=4294967295 \
# -k perm_mod
