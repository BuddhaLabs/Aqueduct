...
#	
#######################DISA INFORMATION##################################
# Group ID (Vulid): RHEL-06-000089
# Group Title: SRG-OS-999999
#
   
# Rule ID: RHEL-06-000089_rule
# Severity: medium
# Rule Version (STIG-ID): RHEL-06-000089
# Rule Title: The system must not accept IPv4 source-routed packets by 
# default.
#
...
# Check Content:
#
# The status of the "net.ipv4.conf.default.accept_source_route" kernel 
