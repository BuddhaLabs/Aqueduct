...
#	
#######################DISA INFORMATION##################################
# Group ID (Vulid): RHEL-06-000137
# Group Title: SRG-OS-000043
#
   
# Rule ID: RHEL-06-000137_rule
# Severity: medium
# Rule Version (STIG-ID): RHEL-06-000137
# Rule Title: The operating system must support the requirement to 
# centrally manage the content of audit records generated by organization 
