...
#	
#######################DISA INFORMATION##################################
# Group ID (Vulid): RHEL-06-000081
# Group Title: SRG-OS-999999
#
   
# Rule ID: RHEL-06-000081_rule
# Severity: medium
# Rule Version (STIG-ID): RHEL-06-000081
# Rule Title: The system must not send ICMPv4 redirects from any 
# interface.
#
...
# Check Content:
#
# The status of the "net.ipv4.conf.all.send_redirects" kernel parameter 
