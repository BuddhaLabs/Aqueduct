...
#	
#######################DISA INFORMATION##################################
# Group ID (Vulid): RHEL-06-000084
# Group Title: SRG-OS-999999
#
   
# Rule ID: RHEL-06-000084_rule
# Severity: medium
# Rule Version (STIG-ID): RHEL-06-000084
# Rule Title: The system must not accept ICMPv4 redirect packets on any 
# interface.
#
# Vulnerability Discussion: Accepting ICMP redirects has few legitimate 
...
# Check Content:
#
# The status of the "net.ipv4.conf.all.accept_redirects" kernel parameter 
...
I4CAAR=` sysctl net.ipv4.conf.all.accept_redirects | awk '{ print $NF}'`
