...
#	
#######################DISA INFORMATION##################################
# Group ID (Vulid): RHEL-06-000304
# Group Title: SRG-OS-000232
#
   
# Rule ID: RHEL-06-000304_rule
# Severity: medium
# Rule Version (STIG-ID): RHEL-06-000304
# Rule Title: The operating system must employ automated mechanisms to 
# detect the presence of unauthorized software on organizational 
# information systems and notify designated organizational officials in 
