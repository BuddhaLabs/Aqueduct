...
#	
#######################DISA INFORMATION##################################
# Group ID (Vulid): RHEL-06-000307
# Group Title: SRG-OS-000265
#
   
# Rule ID: RHEL-06-000307_rule
# Severity: medium
# Rule Version (STIG-ID): RHEL-06-000307
# Rule Title: The operating system must ensure unauthorized, 
# security-relevant configuration changes detected are tracked.
#
