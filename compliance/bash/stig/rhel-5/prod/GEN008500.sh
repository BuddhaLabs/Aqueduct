...
# Rule ID: SV-37983r1_rule
# Severity: low
# Rule Version (STIG-ID): GEN008500
# Rule Title: The system must have IEEE 1394 (Firewire) disabled unless 
# needed.
#
# Vulnerability Discussion: Firewire is a common computer peripheral 
# interface. Firewire devices may include storage devices with the 
# potential to install malicious software on a system or exfiltrate data.
#
