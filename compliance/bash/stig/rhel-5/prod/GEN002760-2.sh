...
#######################DISA INFORMATION##################################
# Group ID (Vulid): V-29241
# Group Title: GEN002760-2
# Rule ID: SV-37657r1_rule
# Severity: medium
# Rule Version (STIG-ID): GEN002760-2
...
# If no results are returned, or the line does not start with "-w", this is 
# a finding.
#
# Fix Text: 
#
