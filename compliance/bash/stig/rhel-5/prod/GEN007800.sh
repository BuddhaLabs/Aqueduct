...
# Rule ID: SV-37611r1_rule
# Severity: medium
# Rule Version (STIG-ID): GEN007800
# Rule Title: The system must not have Teredo enabled.
#
# Vulnerability Discussion: Teredo is an IPv6 transition mechanism 
# involving tunneling IPv6 packets encapsulated in IPv4 packets. 
# Unauthorized tunneling may circumvent network security.
#
