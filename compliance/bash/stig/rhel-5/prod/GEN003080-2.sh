...
#######################DISA INFORMATION###############################
#Group ID (Vulid): V-29289
#Group Title: GEN003080-2
#Rule ID: SV-37745r1_rule
#Severity: CAT II
#Rule Version (STIG-ID): GEN003080-2
#Rule Title: Files in cron script directories must have mode 0700 or less permissive.
#
#
...
#
#Fix Text: Change the mode of the cron scripts.
# chmod 0700 /etc/cron.daily/* /etc/cron.hourly/* /etc/cron.monthly/* /etc/cron.weekly/*   CCI: CCI-000225  
#######################DISA INFORMATION###############################
...
find /etc/cron.daily /etc/cron.hourly /etc/cron.monthly /etc/cron.weekly -type d -perm /7077 -exec chmod u-s,g-rwxs,o-rwxt {} \;
