...
# Rule ID: SV-37382r1_rule
# Severity: medium
# Rule Version (STIG-ID): GEN002990
# Rule Title: The cron.allow file must not have an extended ACL.
#
# Vulnerability Discussion: A readable and/or writeable cron.allow file 
# by other users than root could allow potential intruders and malicious 
# users to use the file contents to help discern information, such as who 
# is allowed to execute cron programs, which could be harmful to overall 
