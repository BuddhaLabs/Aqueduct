...
# Rule ID: SV-37824r1_rule
# Severity: medium
# Rule Version (STIG-ID): GEN005505
# Rule Title: The SSH daemon must be configured to only use FIPS 140-2 
# approved ciphers.
#
...
# Fix Text: 
#
# Edit the SSH daemon configuration and remove any ciphers not starting 
