...
# Rule ID: SV-37629r1_rule
# Severity: medium
# Rule Version (STIG-ID): GEN003610
# Rule Title: The system must not send IPv4 Internet Control Message 
...
# destination.  These messages contain information from the system's route 
# table possibly revealing portions of the network topology.
#
