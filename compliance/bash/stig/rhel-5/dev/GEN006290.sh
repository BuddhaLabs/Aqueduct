...
# Rule ID: SV-37713r1_rule
# Severity: medium
# Rule Version (STIG-ID): GEN006290
# Rule Title: The /etc/news/hosts.nntp.nolimit file must not have an 
# extended ACL.
#
...
# permissions on the hosts.nntp.nolimit file may allow unauthorized 
# modification which could lead to Denial of Service to authorized users or 
