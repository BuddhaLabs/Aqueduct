...
# Rule ID: SV-37875r1_rule
# Severity: medium
# Rule Version (STIG-ID): GEN006140
# Rule Title: The /etc/smb.conf file must have mode 0644 or less 
# permissive.
#
# Vulnerability Discussion: If the "smb.conf" file has excessive 
# permissions, the file may be maliciously modified and the Samba 
# configuration could be compromised.
#
