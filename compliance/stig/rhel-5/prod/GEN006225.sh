...
# Rule ID: SV-37891r1_rule
# Severity: medium
# Rule Version (STIG-ID): GEN006225
# Rule Title: Samba must be configured to use an authentication mechanism 
# other than "share."
#
# Vulnerability Discussion: Samba share authentication does not provide 
# for individual user identification and must not be used.
#
...
# Fix Text: 
#
# Edit the "/etc/samba/smb.conf" file and change the "security" setting 
# to "user" or another valid setting other than "share".     
#######################DISA INFORMATION##################################
