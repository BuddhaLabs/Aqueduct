...
# Rule ID: SV-37826r1_rule
# Severity: medium
# Rule Version (STIG-ID): GEN005507
# Rule Title: The SSH daemon must be configured to only use Message 
...
# Fix Text: 
#
# Edit the SSH daemon configuration and remove any MACs other than 
