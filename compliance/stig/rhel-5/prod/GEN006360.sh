...
# Rule ID: SV-37737r1_rule
# Severity: medium
# Rule Version (STIG-ID): GEN006360
# Rule Title: The files in /etc/news must be group-owned by root or news.
#
# Vulnerability Discussion: If critical system files do not have a 
# privileged group-owner, system integrity could be compromised.
#
...
# If "/etc/news" files are not group-owned by root or news, this is a 
# finding.
