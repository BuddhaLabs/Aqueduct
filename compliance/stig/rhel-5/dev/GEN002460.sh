...
# Check Content:
#
# Ask the SA if a weekly automated or manual process is used to generate 
# a list of setgid files on the system and compare it with the prior list. 
# If no such process is in place, this is a finding.
#
# Fix Text: 
#
# Establish a weekly automated or manual process to generate a list of 
# setgid files on the system and compare it with the prior list. To create 
# a list of setgid files:
