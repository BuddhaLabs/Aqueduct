...
# appropriate) must be owned by root.
#
...
# If no un-commented reference to "ldap" is identified, LDAP is not used 
# for account information on the system and this is not applicable.
