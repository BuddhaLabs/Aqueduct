...
# Rule ID: SV-37830r1_rule
# Severity: medium
# Rule Version (STIG-ID): GEN005511
# Rule Title: The SSH client must be configured to not use Cipher-Block 
# Chaining (CBC)-based ciphers.
#
# Vulnerability Discussion: The (CBC) mode of encryption as implemented 
# in the SSHv2 protocol is vulnerable to chosen-plaintext attacks and must 
# not be used.
